...
public class AS_Offers : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        Texture2D border = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/border.psd") as Texture2D;
        Texture2D ad1 = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/ad1.psd") as Texture2D;
        Texture2D ad2 = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/ad2.psd") as Texture2D;
        Texture2D ad3 = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/ad3.psd") as Texture2D;
...
public class Startup
{
    static Startup()
    {
        EditorPrefs.SetInt("showCounts_mobileTreePack_7", EditorPrefs.GetInt("showCounts_mobileTreePack_7") + 1);
        if (EditorPrefs.GetInt("showCounts_mobileTreePack_7") == 100)    
        { 
        ...
        // Rate me
        EditorPrefs.SetInt("showCounts_rate_mobileTreePack_7", EditorPrefs.GetInt("showCounts_rate_mobileTreePack_7") + 1);
        if (EditorPrefs.GetInt("showCounts_rate_mobileTreePack_7") == 30)                 
        {   
