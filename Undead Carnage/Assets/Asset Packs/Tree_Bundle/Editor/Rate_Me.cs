...
public class Rate_Me : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        Texture2D border = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/Rate_Border.psd") as Texture2D;
        Texture2D ad1 = EditorGUIUtility.Load("Assets/Next_Spring/Tree_Bundle/Editor/Textures/UI/Ads/Rate_Asset.psd") as Texture2D;
        ...
        {
            Application.OpenURL("https://u3d.as/3dbt");
        }
